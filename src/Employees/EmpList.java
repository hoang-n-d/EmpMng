...
public class EmpList extends Vector<Employee>{    
    ...
    public void removeEmp(){
        String code;
        System.out.print(" Enter the code of removed employees: ");
    ...
    public void promote(){
       String code;
        System.out.print(" Enter the code of promote employees: ");
        code = sc.nextLine().toUpperCase();
        int pos = find(code);
        if (pos<0) System.out.println("This code does not exist.");
        else
    ...
    public void print(){
        ...
        System.out.println("-----------------------------");
        for (Employee x: this){
            System.out.println(x.getCode()+","+x.getName()+","+x.getSalary());
        }                     
